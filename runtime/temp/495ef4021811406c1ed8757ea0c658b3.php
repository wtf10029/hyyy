<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\phpStudy\WWW\hyyy\public/../application/admin\view\link\add.html";i:1486271559;s:69:"D:\phpStudy\WWW\hyyy\public/../application/admin\view\pub\extend.html";i:1486270409;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
<head>
  <meta charset="utf-8">
            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class=" form">
                            <form class="cmxform form-horizontal adminex-form" id="commentForm" method="post" action="<?php echo url('Link/add'); ?>">
                                ...
                                <div class="form-group ">
                                    <label for="url" class="control-label col-lg-2">链接url (前需加http://)</label>
                                    <div class="col-lg-10">
                                        <input class="form-control " id="url" type="text" name="url" required />
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="sort" class="control-label col-lg-2">排序 (数字越大越靠前)</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button class="btn btn-primary" type="submit">添加链接</button>
