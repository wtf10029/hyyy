<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\phpStudy\WWW\hyyy\public/../application/admin\view\news\lst.html";i:1486200125;s:69:"D:\phpStudy\WWW\hyyy\public/../application/admin\view\pub\extend.html";i:1486270409;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
<head>
  <meta charset="utf-8">
...
<section>
    ...
    <div class="row">
    <div class="col-sm-12">
    <form id="form1" name="form1" action="<?php echo url('News/delAll'); ?>" method="post">
    <section class="panel">
    ...
    <tbody>
        <?php if(is_array($res) || $res instanceof \think\Collection): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td><?php echo substr($vo['description'],0,101); ?>...</td>
                <td><?php echo $classify[$vo['classify']]; ?></td>
                ...
                <td style="text-align:center;">
                    <a href="<?php echo url('News/edit',array('id'=>$vo['id'])); ?>">
                        <button class="btn btn-xs btn-info" type="button"><i class="fa fa-pencil"></i>&nbsp;编辑</button>
                    </a>
                    <a href="<?php echo url('News/del',array('id'=>$vo['id'])); ?>">
